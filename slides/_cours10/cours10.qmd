...
Voir [ce lien](https://fr.wikipedia.org/wiki/Dilemme_du_tramway) pour plus d'informations.
...
Premièrement, notre prédicteur (temps) est mesuré en utilisant une échelle discrète (i.e., le nombre de semaines). Il s'agit d'un prédicteur ordinal (i.e., un prédicteur avec différentes catégories entre elles) et un meilleur modèle pour ce genre de données est présenté dans cet article : <https://onlinelibrary.wiley.com/doi/abs/10.1111/bmsp.12195>.
...
Pour plus d'informations sur la régression logistique ordinale, voir [ce lien](https://stats.idre.ucla.edu/r/dae/ordinal-logistic-regression/), ce [tutorial](https://osf.io/57hdg/), ou le chapitre 11 de [McElreath (2015)](http://xcelab.net/rm/statistical-rethinking/).
