...
```{r sampling1, eval = TRUE, echo = TRUE, fig.width = 8, fig.height = 4}
#| output-location: fragment
...
```{r eval = TRUE, echo = TRUE, fig.width = 8, fig.height = 6, dev = "png", dpi = 300}
library(imsb)
...
```{r eval = TRUE, echo = TRUE, fig.width = 7.5, fig.height = 5, dev = "png", dpi = 300}
posterior_plot(
    samples = samples, credmass = 0.89,
    rope = c(0.49, 0.51)
    ) +
...
- Calculer le HDI à 95% de la distribution postérieure et en donner
    une représentation graphique (indice : utilisez la fonction `imsb::posterior_plot()`).
...
```{r eval = TRUE, echo = TRUE, fig.width = 10, fig.height = 6, dev = "png", dpi = 300}
