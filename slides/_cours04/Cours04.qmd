...
```{r r2, eval = FALSE, echo = FALSE, fig.width = 7.5, fig.height = 5}
library(effectsize)
library(bayestestR)
library(BEST)
...
```{r plotpost-mod10, eval = TRUE, echo = TRUE, fig.width = 10, fig.height = 5}
...
2. Fitter ce modèle aver `brms::brm()`, interpréter les estimations du modèle, et conclure sur l'effet de la force du vent et de la température.
