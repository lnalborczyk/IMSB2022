...
$\sqrt{x^{2} + y^{2}} \leqslant 1$. La probabilité que le point $M$ appartienne
au disque est $\pi / 4$ puisque le quart de disque est de surface
$\sigma = \pi r^{2} / 4 = \pi / 4$, et le carré qui le
contient est de surface $s = 4 r^{2} / 4 = r^{2} = 1$. Si la loi de probabilité du tirage de point est uniforme, la probabilité de tomber dans le quart de
disque vaut $\sigma / s = \pi / 4$. En faisant le rapport du
