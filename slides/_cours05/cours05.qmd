...
data.frame(z1 = z1, z2 = z2) %>%
  ...
  labs(x = "Numéro d'itération", y = expression(theta) ) + ylim(c(0, 1) )
```
...
géométrie de la distribution postérieure aux alentours de cette position.
